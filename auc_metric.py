#  This code is heavily borrowed from Christian Zimmermann, details see below
#
#
...
class AUC(Base):
    ...
    def stats(self):
        ...
        data = {
            'stats': [epe_mean.item(), epe_median.item(), auc.item()],
            'text_labels': ['EPE Mean', 'EPE Median', 'AUC'],
        }
        return data
